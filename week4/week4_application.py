...
predictions_train, accuracy = predict(train_x, train_y, parameters)
print('\nTrain set accuracy: ', accuracy)

predictions_test, accuracy = predict(test_x, test_y, parameters)
